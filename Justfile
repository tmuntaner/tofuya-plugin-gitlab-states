...
pull:
    ...
    wkg oci pull ghcr.io/tmuntaner/tofuya-provider-gitlab-interface:0.1.0 -o wit/deps/tofuya-provider-gitlab-interface.wasm
...
build:
    ...
    wasm-tools compose target/wasm32-wasip1/release/tofuya_plugin_gitlab_states.wasm \
        -d components/tofuya-provider-gitlab.wasm \
